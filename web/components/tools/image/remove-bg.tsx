      ...
      {!file ? (
        <label className="border-2 border-dashed border-border hover:border-emerald-600/40 rounded-none p-12 flex flex-col items-center justify-center gap-4 cursor-pointer transition-all bg-muted/40 group">
          ...
          <div className="text-center">
            <p className="text-base font-medium text-foreground">Drop photo here or click to browse</p>
            <p className="text-xs text-muted-foreground mt-1">Supports PNG, JPG, WEBP portraits & objects</p>
          </div>
        </label>
      ) : (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-muted/60 border border-border rounded-none p-4 flex flex-col items-center">
              <span className="text-xs font-medium text-muted-foreground self-start mb-3 uppercase tracking-wider">Original Photo</span>
            ...
            <div className="bg-muted/60 border border-border rounded-none p-4 flex flex-col items-center">
              ...
              >
                {processedUrl ? (
                  ...
                  <p className="text-xs text-muted-foreground font-medium">Click Remove Background below to start</p>
                )}
              </div>
            </div>
          </div>
          ...
          {error && (
            <div className="p-4 rounded-none bg-destructive/10 border border-destructive/30 text-destructive text-sm">
              {error}
            </div>
          )}
